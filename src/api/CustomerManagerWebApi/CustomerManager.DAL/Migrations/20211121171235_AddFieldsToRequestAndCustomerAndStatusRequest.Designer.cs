...
namespace CustomerManager.DAL.Migrations
{
    ...
    [Migration("20211121171235_AddFieldsToRequestAndCustomerAndStatusRequest")]
    partial class AddFieldsToRequestAndCustomerAndStatusRequest
    {
            ...
            modelBuilder.Entity("CustomerManager.DAL.Entities.Request", b =>
                {
                    ...
                    b.HasOne("CustomerManager.DAL.Entities.Customer", "StatusRequest")
                        .WithMany()
                        .HasForeignKey("StatusRequestId")
                        .HasConstraintName("fk_requests_customers_status_request_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
